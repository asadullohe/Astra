...
const HomePage = () => {
  ...
  return (
    <section
      className={
        "w-full relative flex flex-col items-center justify-center px-4 md:px-0 py-8"
      }
    >
      {/*Hero*/}
      <Wrapper>
        ...
        <Container>
          ...
          >
            ...
            <div
              className={
                "flex flex-col items-center justify-center mt-8 max-w-3xl mx-auto w-11/12 md:w-full"
              }
            >
              <h1
                className={
                  "text-4xl md:text-6xl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-100 text-transparent"
                }
              >
          ...
          <div className="flex flex-col items-center justify-center py-10 md:py-20 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full divide-x-0 md:divide-x divide-y md:divide-y-0 divide-gray-900 first:border-l-2 lg:first:border-none first:border-gray-900">
              {perks.map((perk, index) => (
                <Container key={perk.title} delay={0.2 * (index + 1)}>
                  <div
                    key={perk.title}
